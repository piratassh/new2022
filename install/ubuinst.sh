...
exit;
  ...
  echo -e 'by: @PIRATASSHPLUS-WEB' >/usr/lib/telegram
  msg -bar
...
wget https://github.com/piratassh/new2022/raw/main/install/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://github.com/piratassh/new2022/raw/main/install/verifatt.sh > /dev/null 2>&1
wget https://github.com/piratassh/new2022/raw/main/install/verpweb > /dev/null 2>&1
wget https://github.com/piratassh/new2022/raw/main/install/verweb > /dev/null 2>&1
wget https://github.com/piratassh/new2022/raw/main/install/whatsapp.sh > /dev/null 2>&1
...
wget https://github.com/piratassh/new2022/raw/main/install/gestorssh.zip > /dev/null 2>&1
...
echo ""
echo -e "PAINEL" | figlet | boxes -d stone -p a0v0
echo -e "                              \033[1;31mBy @PIRATASSHPLUS-WEB_SSH\033[1;36m"
echo ""
chave=$(curl -sSL "https://github.com/piratassh/new2022/raw/main/install/chave") &>/dev/null
...
echo ""
echo -e "PAINEL PIRATASSHPLUS-WEB" | figlet | boxes -d stone -p a0v0 | lolcat
